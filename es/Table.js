...
var Table = /*#__PURE__*/function (_React$Component) {
    ...
    React.Children.forEach(columns, function (column, index) {
      if ( /*#__PURE__*/React.isValidElement(column)) {
        ...
        if (showFooter && footerHeight) {
          ...
          footerCells.push( /*#__PURE__*/React.cloneElement(columnChildren[2], _extends({}, cellProps, footerCellProps)));
        }
  ...
  _proto.render = function render() {
    ...
    var _this$props27 = this.props,
        ...
        rest = _objectWithoutPropertiesLoose(_this$props27, ["children", "className", "data", "width", "style", "isTree", "hover", "bordered", "cellBordered", "wordWrap", "classPrefix", "loading", "showHeader", "showFooter"]);
