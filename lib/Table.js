...
var Table = /*#__PURE__*/function (_React$Component) {
  ...
  function Table(props) {
    ...
    _this.footerWrapperRef = void 0;
    _this.tableHeaderRef = void 0;
    _this.tableFooterRef = void 0;
  ...
  _proto.getTableFooterHeight = function getTableFooterHeight() {
    var _this$props16 = this.props,
        footerHeight = _this$props16.footerHeight,
        showFooter = _this$props16.showFooter;
  ...
  _proto.getCellDescriptor = function getCellDescriptor() {
    ...
    var footerCells = []; // Table footer cell
    ...
    var _this$props18 = this.props,
        ...
        showFooter = _this$props18.showFooter;
    ...
    var headerHeight = this.getTableHeaderHeight();
    var footerHeight = this.getTableFooterHeight();
    React.Children.forEach(columns, function (column, index) {
      if ( /*#__PURE__*/React.isValidElement(column)) {
        ...
        if (showFooter && footerHeight) {
          ...
          footerCells.push( /*#__PURE__*/React.cloneElement(columnChildren[2], (0, _extends2["default"])({}, cellProps, footerCellProps)));
        }
  ...
  _proto.updatePosition = function updatePosition() {
    ...
    if (this.state.shouldFixedColumn) {
      ...
      footerElement && (0, _domLib.addStyle)(footerElement, footerStyle);
  ...
  _proto.renderRow = function renderRow(props, cells, shouldRenderExpandedRow, rowData) {
    ...
    if (shouldFixedColumn && contentWidth > width) {
      ...
      var cellGroupHeight = props.height;

      if (props.isHeaderRow) {
        cellGroupHeight = props.headerHeight;
      } else if (props.isFooterRow) {
        cellGroupHeight = props.footerHeight;
      }

      var mergedSCroll = (0, _utils.mergeCells)(scrollCells);
      return /*#__PURE__*/React.createElement(_Row["default"], (0, _extends2["default"])({}, restRowProps, {
        "data-depth": depth,
        style: rowStyles
      }), fixedLeftCellGroupWidth ? /*#__PURE__*/React.createElement(_CellGroup["default"], {
        fixed: "left",
        height: cellGroupHeight,
        width: fixedLeftCellGroupWidth,
        style: this.isRTL() ? {
          right: width - fixedLeftCellGroupWidth - rowRight
        } : null
      }, (0, _utils.mergeCells)((0, _utils.resetLeftForCells)(fixedLeftCells))) : null, /*#__PURE__*/React.createElement(_CellGroup["default"], null, mergedSCroll), fixedRightCellGroupWidth ? /*#__PURE__*/React.createElement(_CellGroup["default"], {
        fixed: "right",
        style: this.isRTL() ? {
  ...
  _proto.renderTableFooter = function renderTableFooter(footerCells, rowWidth) {
    var footerHeight = this.getTableFooterHeight();
    var headerHeight = this.getTableHeaderHeight();
    var rowProps = {
      'aria-rowindex': 1,
      rowRef: this.tableFooterRef,
      width: rowWidth,
      height: this.getRowHeight(),
      footerHeight: footerHeight,
      isFooterRow: true,
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      role: "rowgroup",
      className: this.addPrefix('footer-row-wrapper'),
      ref: this.footerWrapperRef
    }, this.renderRow(rowProps, footerCells)));
  };
  ...
  _proto.render = function render() {
    ...
    var _this$props27 = this.props,
        ...
        showFooter = _this$props27.showFooter,
        rest = (0, _objectWithoutPropertiesLoose2["default"])(_this$props27, ["children", "className", "data", "width", "style", "isTree", "hover", "bordered", "cellBordered", "wordWrap", "classPrefix", "loading", "showHeader", "showFooter"]);
    ...
    var _this$getCellDescript = this.getCellDescriptor(),
        ...
        footerCells = _this$getCellDescript.footerCells;
    ...
    return /*#__PURE__*/React.createElement(_TableContext["default"].Provider, {
      ...
      style: styles,
      ref: this.tableRef
    }), showHeader && this.renderTableHeader(headerCells, rowWidth), children && this.renderTableBody(bodyCells, rowWidth), showHeader && this.renderMouseArea(), showFooter && this.renderTableFooter(footerCells, rowWidth)));
  };
